...
RSpec.describe DiaryEntry do
  ...
  describe "#count_words" do
    it "returns the number of words in the contents" do
      diary_entry = DiaryEntry.new("my_title", "went shopping today")
  ...
  describe "@reading_time" do
    context "given a wpm of number (200)" do
      it "returns the ceiling of number of mins it takes to read the contents" do
      diary_entry = DiaryEntry.new("my_title", "one " * 450)
